...
resource "snowflake_pipe" "coinlore_data" {
  ...
  auto_ingest       = true
  aws_sns_topic_arn = data.terraform_remote_state.aws.outputs.coinlore_sns_topic_arn
...
resource "snowflake_pipe" "reddit_data" {
  ...
  auto_ingest       = true
  aws_sns_topic_arn = data.terraform_remote_state.aws.outputs.reddit_sns_topic_arn
